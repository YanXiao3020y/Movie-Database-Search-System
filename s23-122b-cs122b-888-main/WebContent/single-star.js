...
function handleResult(resultData) {
    ...
    let starPageHeader = "<p>Star Name: " + resultData[1]["star_name"] + "</p>" +
           "<p>Date Of Birth: ";
    if (resultData[1]["star_dob"]!= null)
        starPageHeader += resultData[1]["star_dob"] + "</p>";
    else
        starPageHeader += "N/A</p>";
    starInfoElement.append(starPageHeader);
